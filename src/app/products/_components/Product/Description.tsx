const Description = () => {
  return (
    <div className=" flex flex-col gap-3">
      <p className=" text-sm text-gray-700">{`ইসলামিক ওয়ালবোর্ড একটি দেয়াল সজ্জার উপকরণ, যা ইসলামিক ক্যালিগ্রাফি, কোরআনের আয়াত, হাদিস বা দোয়ার অংশ দিয়ে সাজানো থাকে। এটি ঘরের পরিবেশকে আধ্যাত্মিক ও শান্তিময় করতে সাহায্য করে এবং ইসলামিক শিক্ষার প্রতি একটি ইতিবাচক স্মরণ করিয়ে দেয়। বিভিন্ন ডিজাইন ও আকারে এটি বাজারে সহজলভ্য।`}</p>
